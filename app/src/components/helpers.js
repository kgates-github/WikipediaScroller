const testContent = `
  Richard Buckminster Fuller (/ˈfʊlər/; July 12, 1895 – July 1, 1983)[1] was an American architect, systems theorist, writer, designer, inventor, philosopher, <a href="https://en.wikipedia.org/wiki/Dymaxion">1 Dymaxion</a> and futurist. <a href="https://en.wikipedia.org/wiki/Dymaxion">2 Dymaxion</a>  He styled his name as R. Buckminster Fuller in his writings, publishing more than 30 books and coining or popularizing such terms as "Spaceship Earth", <a href="https://en.wikipedia.org/wiki/Dymaxion">3 Dymaxion</a> (e.g., Dymaxion house, Dymaxion car, Dymaxion map), "ephemeralization", "synergetics", and "tensegrity".
          
  <p>
  Fuller developed numerous <a href="https://en.wikipedia.org/wiki/Dymaxion">4 Dymaxion</a> inventions, mainly architectural designs, and popularized the widely known geodesic dome; carbon molecules known as fullerenes were later named by scientists for their structural and mathematical resemblance to geodesic spheres. <a href="https://en.wikipedia.org/wiki/Dymaxion">5 Dymaxion</a> He also served as the second World President of <a href="https://en.wikipedia.org/wiki/Dymaxion">Mensa International</a> from 1974 to 1983.[2][3]
  </p>
  <p>
  Fuller was awarded 28 United States patents[4] <a href="https://en.wikipedia.org/wiki/Dymaxion">6 Dymaxion</a> and many honorary doctorates. In 1960, he was <a href="https://en.wikipedia.org/wiki/Dymaxion">Dymaxion</a> awarded the Frank P. Brown Medal from The Franklin Institute. He was elected an honorary member of Phi Beta Kappa in 1967, <a href="https://en.wikipedia.org/wiki/Dymaxion">Dymaxion</a> on the occasion of the 50-year reunion of his <a href="https://en.wikipedia.org/wiki/Dymaxion">Dymaxion</a>  Harvard class of 1917 (from which he was expelled in his first year).[5][6] <a href="https://en.wikipedia.org/wiki/Dymaxion">Dymaxion</a>  He was elected a Fellow of the American Academy of Arts and Sciences in 1968.[7] The same year, he was elected into the National Academy of Design as an Associate member. He became a full Academician in 1970, <a href="https://en.wikipedia.org/wiki/Dymaxion">Dymaxion</a> and he received the Gold Medal award from the <a href="https://en.wikipedia.org/wiki/Dymaxion">American Institute of Architects</a> the same year. Also in 1970, Fuller received the title of Master Architect from Alpha Rho Chi (APX), the national <a href="https://en.wikipedia.org/wiki/Dymaxion">Dymaxion</a> fraternity for architecture and the allied arts.[8] In 1976, he received the St. Louis Literary Award from the Saint Louis University Library Associates.[9][10] In 1977, he received the Golden Plate Award of the American Academy of Achievement.[11] He also received numerous other awards, including the Presidential Medal of Freedom, presented to him on February 23, 1983, by President Ronald Reagan.[12]
  </p>
  <p>
  Life and work
  </p>
